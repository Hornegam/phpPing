                     ...
                     <table class="table">
                         ...
                         <tbody>
                             ...
                             <td>
                                 ...
                                 <button type="submit" value='.$row['id'].'name="id" class="btn btn-primary" data-toggle="modal" id="ler-pagina" data-target=".bd-example-modal-lg">'.$row['nome'].'</button>
                             ...
                             '.renderizePing($row['ip'],$row['id'],$row['nome']).'
   ...
   $(document).ready(function(){
        $("#ler-pagina").click(function(){
            console.log(document.getElementById("teste").value);
               ...
               // $("#conteudo-pagina-lida").load("grafico.php"); 
